...
class Fourth_AzimithDirectRotateSolarPanelFragment : Fragment(R.layout.sm_fragment_azimith_direct_rotate_solar_panel) {
    ...
    private lateinit var compass_doesnt_work_warning : TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        compass_doesnt_work_warning = view.findViewById(R.id.compass_doesnt_work_warning)
        ...
        orientationViewModel = (activity as OptimalOrientationHelperActivity).viewModel
    ...
    override fun onResume() {
        super.onResume()
        // show alert about doesnt working of compass
        if (is_COMPASS_WORKING_FINE){
            compass_doesnt_work_warning.visibility = View.GONE
        }else{
            compass_doesnt_work_warning.visibility = View.VISIBLE
            suggest_azimuth.text = "\uD83E\uDDED❌"
        }

        //Timber.i("is_COMPASS_WORKING_FINE ${is_COMPASS_WORKING_FINE}")
