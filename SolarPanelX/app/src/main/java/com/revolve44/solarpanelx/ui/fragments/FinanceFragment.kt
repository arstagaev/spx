...
class FinanceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //return inflater.inflate(R.layout.fragment_finance2, container, false)
        fontMontserrat = FontFamily(ResourcesCompat.getFont(requireActivity(),R.font.montserrat)!!)
...
//                        }
                            Text(
                                text = "FRAGMENT My Capital (Cost of PV Station + Savings):",
                                color = Color.White,
                                modifier = Modifier
                                    .fillMaxWidth()
